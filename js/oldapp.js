...
document.getElementById('nextTurnBtn').addEventListener(`click`, function() {
  ...
  renderEmptySoldier()
  example(playingDeckA,playingDeckB)
  console.log("poggo")
...
function renderPlayedCardA() {
  if (playedCardA.length === 0) {
    playedCardAEl.classList.remove('shadow','lighterShadow','darkerShadow','back-blue')
    ...
    playedCardAEl.classList.remove('outline','shadow','darkerShadow')
}
}
function renderPlayedCardB() {
  if (playedCardB.length === 0) {
    ...
    playedCardBEl.classList.remove('outline','shadow','darkerShadow')
...
function renderEmptySoldier() {
  let soldierA = playingDeckA[0].title
  let soldierB = playingDeckB[0].title
  playedCardAEl.classList.remove('lighterShadow','shadow','darkerShadow','back-blue',soldierA)
  playedCardAEl.classList.add('outline')
  playedCardBEl.classList.remove('lighterShadow','shadow','darkerShadow','back-blue',soldierB)
  playedCardBEl.classList.add('outline')
}
...
//   playedCardBEl.classList.add(soldierB)
// }
function renderNoHostages() {
  hostageDeckAEl.classList.remove('lighterShadow','shadow','darkerShadow','back-blue')
  hostageDeckAEl.classList.add('outline')
  hostageDeckBEl.classList.remove('lighterShadow','shadow','darkerShadow','back-blue')
  hostageDeckBEl.classList.add('outline')
}
